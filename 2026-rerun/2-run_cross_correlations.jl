...
out_path = string("/1-fnp/psound/psound-wd3/greenland/correlations/fk_750_4250/no_whitening/10_min/icequakes_removed/750m_cross_correlations/")

# correlate 1khz files
NC = workflow(files,cc_len,maxlag,freqmin,freqmax,fs,cmin,cmax,sgn,
	       time_norm,chans,output_times,out_path,geometry,whitening,30000,"single_corr",0,source_chan)
