...
out_path = string("/fd1/solinger/correlations/fk_none/no_whitening/60_min/icequakes_removed/")

# correlate 1khz files
NC = workflow(files,cc_len,maxlag,freqmin,freqmax,fs,cmin,cmax,sgn,
               time_norm,chans,output_times,out_path,geometry,whitening,30000,"single_corr",2)